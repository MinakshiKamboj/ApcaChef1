...
public class TopicsAdapterGoodCustomer extends RecyclerView.Adapter<TopicsAdapterGoodCustomer.MyViewHolder> {
    List<com.apcachef.model.goodCustomer.TopicsItem> topics;
    Context mContext;
    OnListItemClickListener onListItemClickListener;

    public TopicsAdapterGoodCustomer(Context mContext, List<TopicsItem> topics, OnListItemClickListener onListItemClickListener) {
