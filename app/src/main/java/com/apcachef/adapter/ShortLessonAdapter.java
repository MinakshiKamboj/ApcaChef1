...
public class ShortLessonAdapter extends RecyclerView.Adapter<ShortLessonAdapter.MyViewHolder> {
    List<RowsItem> shortLessonList;
    Context mContext;
    OnListItemClickListener onListItemClickListener;

    public ShortLessonAdapter(Context mContext, List<RowsItem> shortLessonList, OnListItemClickListener onListItemClickListener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.short_lesson_item, viewGroup, false);
